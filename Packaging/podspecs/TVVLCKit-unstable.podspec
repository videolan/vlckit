Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/pub/cocoapods/unstable/TVVLCKit-unstable-3.0.0a34-bb538b4e.zip',
    :sha256 => '5fe7135c6a76b717ee362420342e10e7e5dfd4d9901ea9b78a1a32eb76bd02bd'
  }
