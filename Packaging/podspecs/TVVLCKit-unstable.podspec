Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/pub/cocoapods/unstable/TVVLCKit-unstable-3.0.0a42-d1f1be2f2b.zip',
    :sha256 => '6634bd884e705b4dfdece748a74d9ab381b5b75c12ca7b4e1f9b6ee84051eee7'
  }
