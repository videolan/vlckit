Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/pub/cocoapods/prod/VLCKit-3.3.6-c88139b-e38fee84ad.tar.xz',
    :sha256 => '7afce51df50c9111b0eaaa252a267c973df2be81f2e8a18a9a2742460903cdda'
  }
