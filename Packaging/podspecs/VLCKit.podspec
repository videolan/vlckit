Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/pub/cocoapods/prod/VLCKit-3.1.5-5b3b1db-edfd71a3fb.tar.xz',
    :sha256 => '49fd2aa837ee1b6a576912f04a4bf9dfaced7d5cb6fa6d475417bfd3d42c9f30'
  }
