Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/pub/cocoapods/unstable/VLCKit-3.6.0b4-9f63f3c3-34cd4a61.tar.xz',
    :sha256 => '684d7d8b4cd56f871675ad9b7f142c4716a78d7a704a3ed689442ee4935a467e'
  }
