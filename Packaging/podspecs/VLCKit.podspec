Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/pub/cocoapods/prod/VLCKit-3.3.3-0729fd9-f97c87202731a79cc25d3639635e04335ea014e8.tar.xz',
    :sha256 => '4514665559dcec026b219c4dda1ce6ceae4d580d255da3ace4389f97b8f4d6e3'
  }
  s.osx.vendored_framework = 'VLCKit.framework'
  s.source_files = 'VLCKit.framework/Versions/A/Headers/*.h'
  s.public_header_files = 'VLCKit.framework/Versions/A/Headers/*.h'
