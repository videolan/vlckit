Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/pub/cocoapods/unstable/VLCKit-3.6.0b5-efb38477-34cd4a61.tar.xz',
    :sha256 => 'd3e6087c8b8fa5387df664e72ee0b78ca0e159057ee10708f73c34c2171a2acc'
  }
