Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/pub/cocoapods/prod/MobileVLCKit-3.1.3-82c45e9-5a848495ec.tar.xz',
    :sha256 => '4dffc12ef525a6bc5db82a7b4dbfe4c97242c275ba3e82108f84fda0b9dc842b',
  }
