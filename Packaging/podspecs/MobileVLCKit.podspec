Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/pub/cocoapods/prod/MobileVLCKit-3.4.1b7-4b2379f7-8f6ec51c.tar.xz',
    :sha256 => '9ffcc3ddfeef1707d3a648c456b6670864fd856194a6762ae6eadc4ae4c8e04a'
  }
