Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/pub/cocoapods/prod/MobileVLCKit-3.3.5-7ecad45-e38fee84ad.tar.xz',
    :sha256 => 'fce2f4a3a5a5f90e1bc1a40b88cdfe5729117c4d1bc1fd7246159b0b7f93bdae'
  }
