Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/pub/cocoapods/prod/MobileVLCKit-3.2.1-1a32790-64acb7df4.tar.xz',
    :sha256 => '3f571201c9e94f349a00deaa52cbed3a88c94640157455fccac9b8870195835f',
  }
