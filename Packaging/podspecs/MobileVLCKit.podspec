Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/pub/cocoapods/prod/MobileVLCKit-3.1.5-5b3b1db-c6718efd1a.tar.xz',
    :sha256 => 'dd8f0480c58b93dced53ec5887fd127e88121b809458f8dd8eafd2f52826f0ea',
  }
