Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/pub/cocoapods/prod/MobileVLCKit-3.1.1-e6b8ed6-8d1d921470.tar.xz',
    :sha256 => '30459d2e55c01a5272eb9d82ac27a5875f1a6b8c5872bc099689f778c90efce6',
  }
