Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/pub/cocoapods/prod/MobileVLCKit-3.1.0-1773552-3afa138bb6.tar.xz',
    :sha256 => '66802a6e4cf2ea0163187586be32e8a463ca2f8c8b6a1e9bde5a3e97e27b4b5e',
  }
