Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/pub/cocoapods/prod/MobileVLCKit-3.3.4-4ccbf44-1ac2dec2d3.tar.xz',
    :sha256 => '9d0a76c67b7a6095df7271f7b9043a65e58a5b0e5128b9b078401e4628d9ad06'
  }
