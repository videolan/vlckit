Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/cocoapods/prod/TVVLCKit-3.3.0-3f50bac-9f7eea43b8.tar.xz',
    :sha256 => 'be4e44f8df6c0e569632bfae6a84f5457f4b6c19122903a821f4b2709774b77c'
  }
