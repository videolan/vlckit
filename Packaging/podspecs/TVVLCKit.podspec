Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/cocoapods/prod/TVVLCKit-3.1.0-1773552-8b2161fdd6.tar.xz',
    :sha256 => 'd95bb98ceb38fd292ba9fe6cafc59c5156c398a4a0d9b3e5b2137f8a52a683ef'
  }
