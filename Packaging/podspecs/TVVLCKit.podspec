Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/cocoapods/prod/TVVLCKit-3.3.18b1-f5a6124d-9bc28dab.tar.xz',
    :sha256 => '1752e1b3cbb2ef73dadd85a0d5c46a54eeb4f2b5448195f342c53419c89df174'
  }
