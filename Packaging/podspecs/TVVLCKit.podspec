Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/cocoapods/unstable/TVVLCKit-3.6.0b8-394828a1-34cd4a61.tar.xz',
    :sha256 => '8771392b001003788548cfec9e12745e4759903088b9b055caf4c37b2c4dbece'
  }
