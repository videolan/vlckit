Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/cocoapods/prod/TVVLCKit-3.3.13-4145519-7df954cb.tar.xz',
    :sha256 => 'a37caa19fbe4f164b0312cd28f259eb38185cf1e5daa40baf5e45205c7279de0'
  }
