Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/cocoapods/prod/TVVLCKit-3.3.18b7-b525cc1-ff50ff1e.tar.xz',
    :sha256 => 'bbee72c87854052ef12533a87dc0c4e744ad18a02a74db1d790cd5e27bdd1a80'
  }
