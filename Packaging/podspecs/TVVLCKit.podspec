Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/cocoapods/prod/TVVLCKit-3.3.14-a5bac41-ce04499f.tar.xz',
    :sha256 => '00cb5bba744005258255da5d9cd6f540250a17ae18544d5ec663fb99a44981ec'
  }
