Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/cocoapods/prod/TVVLCKit-3.3.17-21ce5c0e-cb1e02fb.tar.xz',
    :sha256 => 'da747dd70bfdd594fac07b5db498ba94cd68f87ad2d7bf10ad20239379a2bea6'
  }
