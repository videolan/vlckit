Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://download.videolan.org/cocoapods/prod/TVVLCKit-3.7.3-319ed2c0-79128878.tar.xz',
    :sha256 => 'b5f90c226ed54d9dc1c03901c60dc7749b74a53caace2c3047e4c0b7a063e46c'
  }
