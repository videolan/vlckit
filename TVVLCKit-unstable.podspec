Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'http://download.videolan.org/pub/cocoapods/unstable/TVVLCKit-unstable-3.0.0a22.zip',
    :sha256 => '71691951e9c035260d4daa2432db78027e1000cafad8347c153f52d9b7e6b18b'
  }
