Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'http://download.videolan.org/pub/cocoapods/unstable/TVVLCKit-unstable-3.0.0a12.zip',
    :sha256 => 'b4ed2857d3112f89ef6b11b5918cbd5a22b00f7e28863b09e46b474148d158f2'
  }
