Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'http://download.videolan.org/pub/cocoapods/unstable/MobileVLCKit-unstable-3.0.0a22.zip',
    :sha256 => 'aa968443714f9246ef529bf43dabb2afda23da598de0d29aedc2f1e7cd8809dc'
  }
